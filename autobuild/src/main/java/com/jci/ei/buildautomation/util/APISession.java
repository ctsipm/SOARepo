...
public class APISession
{
     ...
     * Needs an Scm//logger to log all API operations
     *
     * @param //logger
     */
    public APISession()
        ...
        throws APIException
    {
        ...
        //ip = IntegrationPointFactory.getInstance().createIntegrationPoint(host, portNum, MAJOR_VERSION, MINOR_VERSION );
    ...
    public void terminate() throws APIException, IOException
    {
        ...
        if ( !terminated )
        {
            ...
            {
            	logger.error( "Caught API Exception when releasing session!" );
                throw aex;
            }
            catch ( IOException ioe )
            {
            	logger.error( "Caught IO Exception when releasing session!" );
                throw ioe;
            }
        }
    }
