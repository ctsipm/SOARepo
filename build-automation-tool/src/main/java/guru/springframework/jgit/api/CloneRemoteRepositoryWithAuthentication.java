...
public class CloneRemoteRepositoryWithAuthentication {
    private static final String REMOTE_URL = "ashrujitpal:kolkata@1@github.com:ctsipm/TestRepo.git";

    public static void cloneRemoteRepositoryWithAuthentication() throws IOException, InvalidRemoteException, TransportException, GitAPIException {
